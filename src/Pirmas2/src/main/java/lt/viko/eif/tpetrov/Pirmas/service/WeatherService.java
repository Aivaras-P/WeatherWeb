...
public class WeatherService {
    ...
    public MoonPhaseResponse getMoonPhase(String city) {
        ...
        String url = "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/"
                ...
                + "&include=days&elements=datetime,moonphase,sunrise,sunset";
    ...
    // New method for today's hourly temperature
    ...
    public AirQualityResponse getAirQuality(double lat, double lon) {
        String url = "http://api.weatherapi.com/v1/current.json"
                + "?key=" + weatherApiKey  // pakeiskite kintamojo pavadinimą
                + "&q=" + lat + "," + lon
    ...
    // New method for city autocomplete
